...
export const styles = StyleSheet.create({
  ...
  buttonText: { color: theme.colors.textOnPrimary, fontWeight: "500", textAlign: "center" },
  smallButtonText: { color: theme.colors.textOnPrimary, textAlign: "center", fontSize: 10, },
  ...
  smallButton: { flexDirection: "row", gap: 5, backgroundColor: theme.colors.primary, borderRadius: theme.radius.sm,
     paddingVertical: theme.spacing.xs, paddingHorizontal: theme.spacing.xs, margin: 1, minWidth: "5%" },
  bottomButtonRow: { flexDirection: "row", alignSelf: "center", paddingRight: 60, flexWrap: "wrap" },
  buttonRow: { flexDirection: "row", alignSelf: "center", flexWrap: "wrap" },
  detailsButtonColumn: { flexDirection: "column", gap: theme.spacing.xs, },
  ...
  status: { fontSize: 14, color: theme.colors.primary, fontWeight: "600" },
  ...
  userDetails: { flexDirection: "row", padding: theme.spacing.xs, width: "100%",  minHeight: 12,
    ...
    borderColor: theme.colors.border,},
  detailsField:{ width: "100%", gap: theme.spacing.xs, alignItems: "flex-start", },
