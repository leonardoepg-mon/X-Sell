...
export async function handleDownload(protocol?: number, token?: string) : Promise<HandlerResults> {
  try {
...
export async function handleReportDownload(protocol?: number) : Promise<HandlerResults> {
  try {
    const response = await authFetch(localIP + '/download', {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ id_item: protocol , isReport: true}),
    });
